...
The data is hosted at Cyclistic's cloud data storage [link].(https://divvy-tripdata.s3.amazonaws.com/index.html) (Note: The datasets have a different name because Cyclistic is a fictional company. For the purposes of this case study, the datasets are appropriate and will enable us to answer the business task in hand. The data has been made available by Lyft Bikes and Scooters, LLC under this [license](https://ride.divvybikes.com/data-license-agreement).
...
* Trip start day and ime, with date time data type.
